...
export default function Page() {
  ...
  <div className="prose prose-neutral dark:prose-invert text-justify">
    <p>
      I’m a passionate Android developer with 5+ years of industry experience. Currently, I’m working at AngelOne, enhancing the Android experience to build robust financial solutions that help users manage investments with ease.
    </p>
    <p>
